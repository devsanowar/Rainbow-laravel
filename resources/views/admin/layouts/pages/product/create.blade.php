                        ...
                        <form id="productForm" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group" style="border: 1px solid #ccc">
                                        <input type="text" id="regular_price" name="regular_price" class="form-control"
                                            placeholder="Enter regular price" value="{{ old('regular_price') }}">
                                    </div>
                                    @error('regular_price')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group" style="border: 1px solid #ccc">
                                        <textarea rows="4" id="short_description" name="short_description" class="form-control">{{ old('short_description') }}</textarea>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group" style="border: 1px solid #ccc">
                                        <textarea rows="4" id="ckeditor" name="long_description" class="form-control">{{ old('long_description') }}</textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <div class="mb-2" style="border: 1px solid #ccc">
                                            <input class="form-control" type="file" id="imageInput" name="images[]"
