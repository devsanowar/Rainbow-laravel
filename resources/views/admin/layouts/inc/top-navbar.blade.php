...
<nav class="navbar">
    <div class="col-12">
        ...
        <ul class="nav navbar-nav navbar-left" style="width: 50%">
            ...
            <li style="font-weight: 700"><a href="{{ route('home') }}" class="inbox-btn hidden-sm-down text-uppercase"
                    data-close="true" target="_blank">Visit Website</a></li>
                    ...
                    <li class="body">
                        <ul class="menu list-unstyled custom-profile-signout">
                            <li><a href="{{ route('user.profile') }}">
                                    <div class="icon-circle g-bg-cyan"> <i class="material-icons">account_circle</i>
                                    </div>
                                    <div class="menu-info">
                                        <h4><b>Profile</b> </h4>
                                    </div>
