            ...
            <div class="col-lg-6 col-md-6">
                <div class="continue-shoping-button">
                    <div class="shopping-cart mb-0">
                        <a href="{{ route('shop_page') }}" class="btn btn--base pill shopping-cart__pr mb-3">CONTINUE
                            SHOPPING</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="order-summery ms-auto">
                    ...
                    <div class="checkout text-center">
                        <a href="{{ route('checkout.page') }}" class="btn btn--base pill">PROCEED TO CHECKOUT</a>
